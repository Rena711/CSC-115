public class A2Tester {
	...
	public static void testAverageGrade() {
		...
		UvicCourse csc110 = new UvicCourse("CSC 110", arr1);
		UvicCourse math100 = new UvicCourse("MATH 100", arr2);
		UvicCourse math101 = new UvicCourse("MATH 101", arr3);
		UvicCourse onlyOne = new UvicCourse("onlyOne", arr4);
		...
		result = math101.averageGrade();
		expected = 72.5;
		//System.out.println(result); // for debugging
		displayResults(Math.abs(result-expected)<THRESHOLD, "average grade for math101");

		result = onlyOne.averageGrade();
		expected = 84.0;
		//System.out.println(result); // for debugging
		displayResults(Math.abs(result-expected)<THRESHOLD, "average grade for only one student");
	}
	...
	public static void testGetGrade() {
		...
		expected = -1;
		// System.out.println(result); // for debugging
		displayResults(result==expected, "test when student not in csc110");

		result = math100.getGrade(s3Sid);
		expected = 74;
		// System.out.println(result); // for debugging
		displayResults(result==expected, "get grade of s3b in math100");
	...
	public static void testUpdateGrade() {
		...
		csc110.updateGrade("v00123456", 84);
		result = s1.getGrade();
		expected = 84;
		//System.out.println(result); // for debugging
		...
		csc110.updateGrade("v00998877", 65);
		result = s3a.getGrade();
		expected = 65;
		//System.out.println(result); // for debugging
		...
		math100.updateGrade("v00998877", 66);
		result = s3a.getGrade();
		expected = 64;
		//System.out.println(result); // for debugging
		displayResults(result==expected, "should not update");
	...
	public static void testAddStudent() {
		...
		UvicCourse csc116 = new UvicCourse("CSC 115", arr2);

		Student[] classList = csc115.getClassList();
		displayResults(classList.equals(empty), "csc 115 class list initially empty");
		
		csc116.addStudent(s3);
		Student[]result = csc116.getClassList();
		System.out.println(result); // for debugging
		classList = csc116.getClassList();
		displayResults(arraysEqual(arr3, classList), "csc 116 class list after inserting 1 student");
	...
	public static void testCountAbove() {
		...
		result = A2Exercises.countAbove(csc115, 50);
		expected = 4;
		//System.out.println(result); // for debugging
		displayResults(result==expected, "csc115 grades above 91");
