...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(10,20)");
		result = A1Exercises.greatestCommonDenominator(10, 20);
		expected = 10;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(15,12)");
		result = A1Exercises.greatestCommonDenominator(15, 12);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(999,789)");
		result = A1Exercises.greatestCommonDenominator(999, 789);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		System.out.println("Testing greatestCommonDenominator(100,100)");
		result = A1Exercises.greatestCommonDenominator(100, 100);
		expected = 100;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
